...
public class ListadoCategoriasView extends AWindows {
    @FXML
    ...
    @FXML
    private GridView< CategoriaAgregateDTO> grid;
    private CategoriaViewModel viewModel;
    private ContextMenu contextMenu;
    FilteredList< CategoriaAgregateDTO> listaFiltrada;// = new FilteredList<>(personas, p -> true);

    public ListadoCategoriasView() {
        super();
    ...
    public void setViewModel(CategoriaViewModel viewModel) {
        ...
        if (viewModel != null) {
            ...
            this.titulo.setText("Listado de categorias");
    ...
    private void initGrid() {
        grid.setCellFactory(gridViewCell -> {
            CategoriaCell c = new CategoriaCell();
        ...
        grid.setCellWidth(260);  // Ancho de la celda
        grid.setCellHeight(260); // Alto de la celda
